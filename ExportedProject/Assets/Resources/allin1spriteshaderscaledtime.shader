Shader "AllIn1SpriteShader/AllIn1SpriteShaderScaledTime" {
	Properties {
		...
		[Toggle()] _Outline8Directions ("Outline High Resolution?", Float) = 0
		_OutlineWidth ("Outline Base Width", Range(0, 0.2)) = 0.004
		[Toggle()] _OutlineIsPixel ("Outline is Pixel Perfect?", Float) = 0
		_OutlinePixelWidth ("Outline Base Pixel Width", Float) = 1
		[Space] [Toggle()] _OutlineTexToggle ("Outline uses texture?", Float) = 0
		_OutlineTex ("Outline Texture", 2D) = "white" {}
		_OutlineTexXSpeed ("Texture scroll speed X", Range(-50, 50)) = 10
		_OutlineTexYSpeed ("Texture scroll speed Y", Range(-50, 50)) = 0
		[Toggle()] _OutlineTexGrey ("Texture is Greyscaled?", Float) = 0
		[Space] [Toggle()] _OutlineDistortToggle ("Outline uses distortion?", Float) = 0
		...
		_GradTopRightCol ("Top Color 2", Vector) = (1,0,0,1)
		_GradBotLeftCol ("Bot Color", Vector) = (0,0,1,1)
		_GradBotRightCol ("Bot Color 2", Vector) = (0,0,1,1)
