...
public class VideoDialog3700083 : MonoBehaviour
{
	...
	public void ClickZimu()
	{
		...
		if (pos == 10f)
		{
			gameManager.musicManager.PlayMusicLoop(17);
		}
		iscanclick = true;
		...
		else if (pos >= (float)zimus.Length && !hundown)
		{
			...
			Invoke("ShowJiewei", 2f);
		}
	}

	private void ShowJiewei()
	{
		Object.Instantiate(Resources.Load<GameObject>("Dialog/jiewei/jiewei"), gameManager.homeScene.middle).name = "jiewei";
