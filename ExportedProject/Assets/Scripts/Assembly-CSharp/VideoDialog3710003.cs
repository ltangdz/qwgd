...
public class VideoDialog3710003 : MonoBehaviour
{
	...
	public void ClickZimu()
	{
		...
		else if (pos >= (float)zimus.Length && !hundown)
		{
			...
			gameManager.player.playerdata.isCanCatch = true;
			gameManager.player.playerdata.isstarttask = true;
			gameManager.homeScene.goalDialog.CompleteItem("2010003");
			gameManager.player.playerdata.reasoninglist.Add("4013");
	...
	public void HideVideoDialog()
	{
		...
		gameManager.homeScene.ShowCatchButton();
		gameManager.homeScene.goalDialog.CompeleteOneItem("2010003");
