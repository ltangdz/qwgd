...
public class HackerVideoDialog01 : MonoBehaviour
{
	...
	public void HideVideoDialog()
	{
		...
		Object.Instantiate(Resources.Load("Dialog/Hacker/hackeruploaddialog01") as GameObject, homeScene.middle).GetComponent<HackerUploadDialog>().Show();
	}
}
