...
public class CoursePanel15 : MonoBehaviour
{
	...
	public GameObject maillogindialog;
	...
	{
		DeleteHighLight(maillogindialog);
	}
	...
	private IEnumerator StartHideCourse(bool isactive)
	{
		...
		gameManager.player.playerdata.isCourse15 = 1;
		if (gameManager.homeScene.browserMail != null)
		{
			gameManager.homeScene.browserMail.imgDragArea.SetActive(value: true);
		}
		if (isactive)
		{
			gameManager.CanShowSetting(-1);
