...
public class CoursePanel06 : MonoBehaviour
{
	...
	{
		DeleteHighLight(btn_pojie, isneedclick: true);
	...
	private IEnumerator StartHideBlack()
	{
		...
		gameManager.player.playerdata.isCourse06 = 1;
		if (gameManager.homeScene.passworddialog1 != null)
		{
			gameManager.homeScene.passworddialog1.imgDragArea.SetActive(value: true);
		}
		...
		AddHighLight(btn_pojie, isneedclick: true);
		MoveArrow();
	}
