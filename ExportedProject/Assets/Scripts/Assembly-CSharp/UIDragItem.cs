...
public class UIDragItem : MonoBehaviour, IBeginDragHandler, IEventSystemHandler, IDragHandler, IEndDragHandler
{
	public int chessid;
	...
	public void OnEndDrag(PointerEventData eventData)
	{
		...
		if (gameObject != null)
		{
			...
			else if (gameObject.tag.Equals("scandialog"))
			{
				...
				gameObject.transform.parent.parent.GetComponent<ScanDialog>().StartScan(dATA.ID.ToString());
				ResetPosition();
			}
