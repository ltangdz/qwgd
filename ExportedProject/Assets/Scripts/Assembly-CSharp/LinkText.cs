...
public class LinkText : MonoBehaviour
{
	...
	private void Start()
	{
		strFragment = I18N.instance.getValue(strFragment);
		Init();
	}
	...
	public void EnterLink()
	{
		...
		txt_content.text = I18N.instance.getValue(allText + "enter");
	}
	...
	public void ExitLink()
	{
		...
		img_line.color = color;
		txt_content.text = I18N.instance.getValue(allText + "exit");
	}
	...
	private void Init()
	{
		...
		component.SetInsetAndSizeFromParentEdge(RectTransform.Edge.Left, GetLinePreWidth(strFragment) + offx1, CalculateLengthOfText(strFragment));
		...
		component2.SetInsetAndSizeFromParentEdge(RectTransform.Edge.Left, GetLinePreWidth(strFragment) + offx1, CalculateLengthOfText(strFragment));
