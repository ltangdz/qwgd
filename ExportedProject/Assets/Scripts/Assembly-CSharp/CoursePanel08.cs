...
public class CoursePanel08 : MonoBehaviour
{
	...
	public GameObject btn_changeid;
	...
	{
		DeleteHighLight(btn_changeid, isneedclick: true);
	...
	private IEnumerator StartHideBlack()
	{
		...
		AddHighLight(btn_changeid, isneedclick: true);
		MoveArrow();
	}
