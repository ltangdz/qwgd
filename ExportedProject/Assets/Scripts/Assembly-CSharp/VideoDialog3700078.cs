...
public class VideoDialog3700078 : MonoBehaviour
{
	...
	private void Start()
	{
		...
		gameManager.player.playerdata.isDelVan = true;
	...
	private IEnumerator StartShowVideo()
	{
		...
		gameManager.soundManager.PlaySoundLoop(45);
		yield return new WaitForSeconds(5f);
		gameManager.soundManager.StopLoop();
		Object.Instantiate(Resources.Load<GameObject>("Dialog/videoDialog3700079"), gameManager.homeScene.middle);
