...
{
	public class CardTipDLC8 : AlubaSpawnDLC8
	{
		...
		public void InitData(CardDLC8 cardDlc8)
		{
			extraText.gameObject.SetActive(!cardDlc8.IsEffectCard());
			switch (cardDlc8.Type)
			{
			case CardType.ATTAKER:
				...
				extraText.text = string.Format(I18N.getValue("^110008_game_93"), cardDlc8.Attack, cardDlc8.ExtraAttack);
				break;
			case CardType.QUEEN:
				titleText.text = string.Format("[{0}]", I18N.getValue("^110008_game_92"));
				descText.text = I18N.getValue("^110008_game_32");
				extraText.text = string.Format(I18N.getValue("^110008_game_94"), cardDlc8.Attack, cardDlc8.QueenBuff);
				break;
