...
{
	public class DDOSEventManagerDLC8
	{
		private static DDOSEventManagerDLC8 _instance;

		public static DDOSEventManagerDLC8 Instance
		{
			get
			{
				if (_instance == null)
				{
					_instance = new DDOSEventManagerDLC8();
				}
				return _instance;
			}
		}
		...
		public event Action<GameWavesType, int> onNoticeGameWaves;
		...
		public void NoticeGameWaves(GameWavesType type, int enemyCount)
		{
			if (this.onNoticeGameWaves != null)
			{
				this.onNoticeGameWaves(type, enemyCount);
			}
		}
