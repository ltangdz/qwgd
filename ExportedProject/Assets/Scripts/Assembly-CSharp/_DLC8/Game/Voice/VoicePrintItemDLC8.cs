...
{
	public class VoicePrintItemDLC8 : DragBagGrid<VoicePrintModelDLC8>, IPointerEnterHandler, IEventSystemHandler, IPointerExitHandler
	{
		...
		public void SaveData(VoicePrintModelDLC8 sourceItemDataItem)
		{
