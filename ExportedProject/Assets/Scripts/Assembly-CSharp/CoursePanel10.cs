...
public class CoursePanel10 : MonoBehaviour
{
	...
	private IEnumerator StartHideCourse(bool isactive)
	{
		...
		gameManager.player.playerdata.isCourse10 = 1;
		if (gameManager.homeScene.weizhuang != null)
		{
			gameManager.homeScene.weizhuang.imgDragArea.SetActive(value: true);
		}
		if (isactive)
		{
			gameManager.CanShowSetting(-1);
